...
# 🔸 Persistent Runtime Cycle Intervals ============================

PRC_THEA = 300                              # 5 minutes
    
# 🔸 Heartbeat Update Intervals (seconds) ==========================

# HB_ALEC =                                 # awaiting persistence
HB_ASH = 30                                 # 30 seconds
# HB_GRAYSON =                              # awaiting persistence
HB_HELEN = 60                               # 1 minute
HB_JULIUS = 60                              # 1 minute
HB_THEA = 300                               # 5 minutes
HB_EDITH = 600                              # 10 minutes
HB_ALMA = 60                                # 1 minute
HB_LAUREL = 60                              # 1 minute

# 🔸 Pre-filter Parameters  ========================================

MIN_24H_VOLUME: float = 3000000             # 3M USDT minimum volume
MAX_24H_VOLUME: float = 200000000           # 200M USDT maximum volume
MIN_COIN_AGE: int = 7                       # Minimum days of trading required

# 🔸 Datapoint Collection Parameters  =====================================    

TICKERS_CAPTURE_INT = 3     # seconds       # Every 3 seconds
SIGNALS_CAPTURE_INT = 300   # seconds       # Every 5 minutes
BATCH_SIZE = 10                             # Process symbols in batches
CANDLE_15M_LIMIT = 96                       # 24 hours of 15 minute candles
CANDLE_1H_LIMIT = 24                        # 24 huors of 1 hour candles
BOOK_DEPTH = 20                             # Top 20 levels each side
TRADES_LIMIT = 100                          # Last 100 trades per pair
...
HEARTBEAT_TIMEOUT: int = 60                 # Seconds before considering system unresponsive
